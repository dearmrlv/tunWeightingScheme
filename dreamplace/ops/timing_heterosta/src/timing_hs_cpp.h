...
// Custom hash function for pair<long, long> to use as unordered_map key
struct PairHash {
...
// Type alias for the pin-to-pin weight map
using Pin2PinWeightMap = std::unordered_map<std::pair<long, long>, float, PairHash>;
...
public:
    ...
    /// @param pin2node_map the pin to node mapping array.
